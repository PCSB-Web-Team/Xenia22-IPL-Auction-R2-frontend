...
const ImpactPlayer = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const selectedPlayer = playerArray.find(
      (player) => player.name === impactPlayer
    );

    let inst = {
      impact_player_name: impactPlayer,
      slotId: selectedPlayer ? selectedPlayer.slotId : null,
    };
                ...
                >
                  ...
                  <div className="card-content text-center">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        if (e.target.checked) setImpactPlayer(member.name);
                      }}
